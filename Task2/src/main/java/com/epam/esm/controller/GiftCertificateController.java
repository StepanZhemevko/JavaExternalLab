...
public class GiftCertificateController {
    ...
    @GetMapping("/order/{userLogin}")
    public List<GiftCertificate> getCertificatesByUserLogin(@PathVariable("userLogin") String userLoin) {
        return giftCertificateService.findCertificateByUserLogin(userLoin);
    }
    @GetMapping("/{id}")
    ...
    public List<GiftCertificate> getAllCertificates() {
        return giftCertificateService.findAllGifts();
    }
